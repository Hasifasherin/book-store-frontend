...
export default function SellersList() {
  ...
  const toggleBlock = async (seller: Seller) => {
    try {
      ...
      const endpoint = seller.isBlocked
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/admin/sellers/${seller._id}/unblock`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/admin/sellers/${seller._id}/block`;
